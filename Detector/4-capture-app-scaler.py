...
# Define as features numéricas que devem ser normalizadas
...
# Inicializa o StandardScaler para as features numéricas
...
# Função para normalizar os dados numéricos com StandardScaler
def normalize_value(value):
    # Transforma o valor em uma lista e aplica a normalização
    return scaler.fit_transform(np.array([[value]]))[0][0]  # Normaliza o valor numérico
